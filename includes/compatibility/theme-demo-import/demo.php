...
*/
add_filter( 'theme-demo-import/import_files', 'light_bold_import_files' );
function light_bold_import_files() {
    return array(
        array(
            'import_file_name'           => 'Light & Bold Demo Import',
...
*/
add_action( 'theme-demo-import/after_import', 'light_bold_set_menu_and_pages' );
function light_bold_set_menu_and_pages() {
    // Assign menus to their locations.
    $main_menu = get_term_by( 'name', 'Main menu', 'nav_menu' );
    $sub_menu = get_term_by( 'name', 'Footer quick link', 'nav_menu' );

    set_theme_mod( 'nav_menu_locations', array(
            'primary' => $main_menu->term_id,
            'sub-footer' => $sub_menu->term_id,
        )
    );
