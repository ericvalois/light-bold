...
function light_bold_widgets_init() {
	register_sidebar( array(
		...
		'before_widget' => '<div id="%1$s" class="mb2 md-mr3 footer_widget %2$s clearfix">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		...
		'before_widget' => '<div id="%1$s" class="mb2 footer_widget %2$s clearfix">',
		'after_widget'  => '</div>',
		'before_title'  => '<h6 class="widget-title main-color separator upper mb2 mt0 small-p">',
		'after_title'   => '</h6>',
	) );
	...
	register_sidebar( array(
		...
		'before_widget' => '<div id="%1$s" class="perf_widget mb2 %2$s clearfix">',
		'after_widget'  => '</div>',
