...
<div id="social_widget" class="clearfix mb2 hide-print">
	...
	<div class="left table mb1 mr1">
		<a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo get_permalink(); ?>&title=<?php echo urlencode( get_the_title() ); ?>" class="table-cell social_share"><i class="fa fa-linkedin"></i></a>
	</div>
