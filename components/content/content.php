...
<article id="post-<?php the_ID(); ?>" <?php post_class("border-bottom break-word mb2 md-mb3"); ?>>
    <div class="sticky-meta ultra-small upper mb1">
        ...
        <span class="inline-block px"> | </span><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>" class="dark-color"><?php echo get_the_author(); ?></a>
    </div>
