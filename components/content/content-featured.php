<?php
	...
	<?php if ( $featured_query->have_posts() ) : ?>
		...
		<?php while ( $featured_query->have_posts() ) : $featured_query->the_post(); ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class("featured table col-12"); ?>>
				<div class="<?php if( has_post_thumbnail() ){ echo 'md-col-7 md-table-cell'; } ?> align-top dark-bg px2 sm-px3 md-px4 py3 md-py4 ">
					...
					<h2 class="entry-title h1 separator mb3 mt0"><a class="white-color" href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
