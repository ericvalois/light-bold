...
function perf_preload() {
    ...
    <link rel="preload" href="<?php echo get_template_directory_uri(); ?>/inc/font-awesome/fonts/fontawesome-webfont.woff2" as="font" type="font/woff2" media="(min-width: 64em)" crossorigin>
    <?php
}
