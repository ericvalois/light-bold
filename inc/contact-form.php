	...
	<form action="<?php echo esc_url( $_SERVER['REQUEST_URI'] ); ?>#contact_form" method="post">
		...
		<div class="clearfix mxn2">
			<div class="md-col md-col-6 px2 mb2">
				<label for="cf-name"><?php _e("Name","perf"); ?></label> <span class="main-color">*</span>
			...
			<div class="md-col md-col-6 px2 mb2">
				<label for="cf-email"><?php _e("Email","perf"); ?></label> <span class="main-color">*</span>
		...
		<div class="mb2">
			<label for="cf-subject"><?php _e("Subject","perf"); ?></label> <span class="main-color">*</span>
		...
		<div class="mb2">
			<label for="cf-message"><?php _e("Message","perf"); ?></label> <span class="main-color">*</span>
	...
	if ( isset( $_POST['cf-submitted'] ) ) {
		...
		if ( $recaptcha && wp_mail( $to, $subject, $message, $headers ) ) {
			...
			if( get_field("perf_contact_success_message","option") ){
				...
				echo '<p id="contact_form" class="green-color">' . __("Your message was successfully sent. Thank you.","perf") . '</p>';
			}
			echo '</div>';
		} else {
			...
			if( get_field("perf_contact_error_message","option") ){
				...
				echo __("There was a problem with your submission. All fields are required","perf");
			}
			echo '</p>';
		}
	}
